...
`payments/src/audit.ts` includes `amountCents` on every audit record. Control closed on branch `cursor/fix-sub-8-pci-10-2-a215`. Linear: **SUB-8**. Label: `control:pci-10.2`.
